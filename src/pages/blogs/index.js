...
function Blogs() {
    const blogPosts = Array.from({ length: 5 }, (_, i) => (
        <article key={i} className="post-preview py-10 border-b ">
            <p className="text-xl md:text-2xl font-medium">How to use environment variables in Next.js (includes a working example app)</p>
            ...
            <p className="py-6 leading-loose text-sm md:text-base">
    ...
    return (
        <section className="main py-32">
            <div className="container">
                <h1 className="text-4xl md:text-5xl text-sky-950 font-bold">Blog Posts</h1>
                <article className="md:w-2/3 xl:w-1/3">
                    <p className="pt-4 text-stone-500 leading-loose text-sm md:text-base">
                ...
                <div className="w-full lg:w-2/3 pt-16">
                    {blogPosts}
                </div>
            </div>
        </section>
